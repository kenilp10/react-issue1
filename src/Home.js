...
function Home(props) {
  ...
  useEffect(() => {
    axios.get(` https://node-issue2.herokuapp.com/data`).then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    setformdata(data);
    console.log('datajkhjkk===',data)
    // console.log('formdata==>>',formdata)   
  
    if( input){
      console.log(formdata);
      axios.post("https://node-issue2.herokuapp.com/data", data)
 ...
 const onLogOut = () => {
  ...
  return (
    ...
    .map((i) => {
                  ...
                  var image1 = i.image && i.image.substr(8,i.image.length);
                          ...
                          <Accordion>
                            <Accordion.Item eventKey="0">
                              ...
                              <Accordion.Body>
                                ...
                                >
                                  <img style={{width:"200px",height:"100px"}} src= {`https://node-issue2.herokuapp.com/${image1}`} alt='thump'/>
                                        

                           {/* <img style={{width:"200px",height:"100px"}} src= {require(`./assets/${i.image}`)} alt='thump'/>
                                       :
                               <iframe  style={{width:"200px",height:"100px"}} src={(`./assets/${i.image}`)} title="hello"></iframe>
                               } */}
