...
function Admin() {
  ...
  const deleteItem = (id) => {
    ...
    if (window.confirm("are you sure??  you want to delete data??")){
      axios.delete(`https://node-issue2.herokuapp.com/data/${id}`);
      axios.get(`https://node-issue2.herokuapp.com/data`).then((res) => {
        setAllData(res.data);
  ...
  const handleUpdate = (e) => {
    ...
    if (window.confirm("are you sure??  you want to update data??")) {
      axios.put(`https://node-issue2.herokuapp.com/data/${isEditIsuue}`, data);
          ...
          <div className=" rounded" style={{ margin: "12px" }}>
            ...
            <Row>
              {allData
                ...
                .map((i) => {
                  var media1 = i.image && i.image.substr(8,i.image.length);
                  return (
                  ...
                  <img style={{width:"200px",height:"100px"}} src= {`https://node-issue2.herokuapp.com/${media1}`} alt='thump'/>
